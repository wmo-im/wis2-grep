...
BROKER_URL = os.environ.get('WIS2_GREP_BROKER_URL')
CENTRE_ID = os.environ.get('WIS2_GREP_CENTRE_ID')
CACHE_URL = os.environ.get('WIS2_GREP_CACHE_URL')
CACHE_RETENTION_SECONDS = int(os.environ.get('WIS2_GREP_CACHE_RETENTION_SECONDS', 3600))  # noqa
...
if None in [API_URL, API_URL_DOCKER, BACKEND_TYPE, BROKER_URL, CACHE_URL,
            BACKEND_CONNECTION, CENTRE_ID, GB, INCLUDE_GATEWAYS,
